...
public final class MemberCompositionRoot {
    ...
    private Map<Class<? extends ICommand>, ICommandHandler> commandHandlers() {
        ...
        map.put(RegisterNewUserCommand.class, new LoggingCommandHandlerDelegator(new RegisterNewUserCommandHandler(userRepository(), passwordEncrypter())));
        map.put(ConfirmUserIdCommand.class, new LoggingCommandHandlerDelegator(new ConfirmUserCommandHandler(userRepository())));
        return map;
    }
}
